...
/// <summary>
/// Represents a recorded invocation of <see cref="IConcurrencyController.VerifyVersion{TEntity}"/>.
/// </summary>
...
public sealed record VerifyVersionInvocation(object Entity, ExpectedVersion Expected, string EntityId, DateTimeOffset Timestamp);
